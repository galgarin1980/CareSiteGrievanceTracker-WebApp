...
export class ApiDataService {
  private connectionString: string = "https://localhost:44368/api/Temp"; //<-- Data API
  ...
  constructor(private http: HttpClient, private authService: AuthenticationService) {
    ...
    this.authService.currentUser.subscribe(user => { this.user = user; console.log("CareSite service user", user) });
